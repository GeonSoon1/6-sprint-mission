...
/*
  ...
  - 현재 로그인한 유저 id가 1이라고 가정
*/
INSERT INTO products (author_id, category_id, status_id, name, price, tags)
VALUES (1, 1, 1, '스마트TV', 1000000, ARRAY['TV']);
...
*/
SELECT products.*,
       (SELECT COUNT(*) FROM favorites WHERE favorites.product_id = products.id) AS like_count
FROM products
