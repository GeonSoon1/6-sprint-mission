...
*/
SELECT *
FROM products p JOIN likes l ON p.user_id = l.user_id
WHERE p.user_id = 1
OFFSET 20 LIMIT 10;
...
VALUES (1, '상품생성', '새롭게 만든 상품 설명입니다.', 3000);
...
*/
UPDATE products
SET name = '상품수정', description = '수정된 설명입니다.'
WHERE id = 1;
/*
  10. 상품 삭제
  - 1번 상품 삭제
...
VALUES (1, 2, '1번 유저가 2번 상품에 다는 댓글입니다.');
